...
if log_repairing_quality:
    log_fpath += '/home/ph/Git/HoloClean/experiments/hospital_2_batches/repairing_quality/baseline_1.csv'

if log_execution_times:
    log_fpath += '/home/ph/Git/HoloClean/experiments/hospital_2_batches/execution_times/baseline_1.csv'
...
for current_iteration in range(number_of_iterations):
    ...
    hc.load_data(dataset_name, '../testdata/' + dataset_name + '.csv')
