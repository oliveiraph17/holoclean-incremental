...
if log_repairing_quality:
    log_fpath += '/home/ph/Git/HoloClean/experiments/' + dataset_name + '/10_batches/repairing_quality/proposal_5.csv'

if log_execution_times:
    log_fpath += '/home/ph/Git/HoloClean/experiments/' + dataset_name + '/10_batches/execution_times/proposal_5.csv'
