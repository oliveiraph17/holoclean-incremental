...
if log_repairing_quality:
    log_fpath += '/home/ph/Git/HoloClean/experiments/' + dataset_name + '/2_batches/repairing_quality/proposal_5.csv'

if log_execution_times:
    log_fpath += '/home/ph/Git/HoloClean/experiments/' + dataset_name + '/2_batches/execution_times/proposal_5.csv'
...
for current_iteration in range(number_of_iterations):
    ...
    for current_batch in batches:
        if current_batch_number == batch_stopping_training:
            skip_training = True
