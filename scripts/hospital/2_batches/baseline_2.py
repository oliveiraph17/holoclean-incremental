...
if log_repairing_quality:
    log_fpath += '/home/ph/Git/HoloClean/experiments/' + dataset_name + '/2_batches/repairing_quality/baseline_2.csv'

if log_execution_times:
    log_fpath += '/home/ph/Git/HoloClean/experiments/' + dataset_name + '/2_batches/execution_times/baseline_2.csv'
