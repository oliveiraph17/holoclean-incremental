...
arguments = [
    ...
    (('-fn', '--feature-norm'),
     {'metavar': 'FEATURE_NORM',
      ...
      'default': True,
      'type': bool,
      'help': 'Normalizes the features before training.'}),
    (('-wn', '--weight-norm'),
     {'metavar': 'WEIGHT_NORM',
      'dest': 'weight_norm',
      'default': False,
      'type': bool,
      'help': 'Normalizes the weights after every forward pass during training.'}),
    (('-ee', '--estimator-epochs'),
     {'metavar': 'ESTIMATOR_EPOCHS',
      'dest': 'estimator_epochs',
      'default': 3,
      'type': int,
      'help': 'Number of epochs for which to run the weak labelling and domain generation estimator.'}),
